...
#Updates to be able to toggle lights

    def TopRightOn(self):
        os.system("xboxdrv -l 7")

    def BottomRightOn(self):
        os.system("xboxdrv -l 9")

    def BottomLeftOn(self):
        os.system("xboxdrv -l 8")

    def TopLeftOn(self):
        of.system("xboxdrv -l 6")

    def TopRightOff(self):
        pass

    def BottomRightOff(self):
        pass

    def BottomLeftOff(self):
        pass
